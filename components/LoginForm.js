...
export default function LoginForm({ onLogin }) {
  ...
  return (
    <form className="w-8/12 p-6 mx-auto my-8 rounded-lg shadow-md bg-white-300" onSubmit={handleSubmit}>
      <fieldset className="flex flex-col" autoComplete="off">
        <label htmlFor="username" className="mt-2">Username</label>
        <input name="username" className="p-2 mt-2 rounded" placeholder="User Name" />
